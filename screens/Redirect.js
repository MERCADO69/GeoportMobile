...
export default function IdentityVerification() {
  ...
  const takeFacePhoto = async () => {
    try {
      ...
      Alert.alert(
        "⚠️ Error",
        "Failed to capture face photo. Please try again."
      );
    } finally {
      setLoading(false);
    }
      ...
      {idValidated ? (
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <Text style={styles.infoText}>
            Please verify your face to complete the process
          </Text>
          ...
          {loading ? (
            ...
            <Animated.View style={[styles.buttonCard, { opacity: fadeAnim }]}>
              <TouchableOpacity onPress={takeFacePhoto} style={styles.button}>
                <LottieView
                  source={require("../assets/face_animation.json")}
                  autoPlay
                  loop
                  style={styles.lottie}
                />
        ...
        <ScrollView contentContainerStyle={styles.container}>
          {loading ? (
            ...
            <ScrollView contentContainerStyle={styles.container}>
              ...
              <Text style={styles.infoText}>
                Capture your ID first, then scan your face for verification.
              </Text>

              <Animated.View style={[styles.buttonCard, { opacity: fadeAnim }]}>
                <TouchableOpacity
                  onPress={openCameraForID}
                  style={styles.button}
                >
                  <LottieView
